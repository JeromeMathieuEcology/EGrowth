 ...
 fluidRow( 
  ...
  column(width = 8,offset = 1, 
   ...
   strong("Panel 'Metadata'"),
      ...
      h5("Below that you will find a contingency table that summarizes the treatment that were studied in the corresponding curves"),
      h5("The first column describes the type of treatment, the second tells the number of curves that studied this kind of treatment"),
      br(),
      h5("On the right, you will find three plots on the first row. The are histogramms of the year of publication, temperature and ph of the substrate in the selected growth curves"),
      h5("Second line tells the number of species selected, and the nubmer of curves selected"),
      h5("Last, you will find a map of the location of the specimens used to produce the curves. You can zoom and pan the map."),
   ...
   strong("Panel 'Compare Curves' "),
      ...
      h5("Growth curves can be colored by type of temperature of pH. They appear in gray if the information is missing. "),
      br(),
    ...
    strong("Panel 'Explore growth curves'"), 
      ...
      h5("WARNING : the x axis should not be interpreted as age. The age at date 0 vary from curve to curve and
      rarely is the day of birth." ),
      br(),
      ...
      h5("- the left column shows the raw data, with a loess fit in red. The ID of the curve is mentionned, as well as the treatment type"),
      h5("- the right column shows a map with the origin of the individuals used to produce the curve (this is not necessary were the exeperiment was performed)"),
      h5("- below the map, environmental conditions used to produce the curve, and the source of the curve, are summarized."),
      br(),
      br(),
